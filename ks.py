...
def start(message):
    ...
    caption = "اهلا بك في بوت **كلاش اوف كلانس** التليجرامي 🎮\n" \
              "هنا تبني قريتك المصغرة تدرب جيشك وتحارب اصدقاءك او اعداء عشوائيين\n" \
              "ابدا بكتابة 'إنشاء قرية' لإنشاء قريتك\n" \
...
def create_village(message):
    ...
    if c.fetchone():
        ...
        username = message.from_user.username or f"User{user_id}"  # حفظ الاسم هنا
